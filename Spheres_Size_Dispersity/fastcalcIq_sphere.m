...
ntheta=91;
nq = 931;
start_q = 0.0230403441;
end_q = 0.1799211129;
qgrid = linspace(start_q, end_q, nq)'*ones(1,ntheta);
...
Finaldata=10.^dataxy;
Finaldata1D = mean(Finaldata, 2);
writetable(array2table(Finaldata1D), [outfilename '_dataIq.txt'])
